<div class="p-8">
  <div class="flex justify-between items-center mb-8">
    ...
    <div class="flex gap-3">
      <a href="index.php?page=usuarios/form" 
      ...
      <a id="btnReporte"
         href="index.php?page=usuarios/reporte"
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  buscador.addEventListener('keyup', () => {
    ...
    fetch(`index.php?page=usuarios/buscar&q=${encodeURIComponent(query)}`)
      .then(res => res.text())
      .then(html => {
  ...
  // 📤 Generar reporte con o sin filtro
  btnReporte.addEventListener('click', e => {
    e.preventDefault();
    const query = buscador.value.trim();
    const url = query 
      ? `index.php?page=usuarios/reporte&q=${encodeURIComponent(query)}`
      : `index.php?page=usuarios/reporte`;
